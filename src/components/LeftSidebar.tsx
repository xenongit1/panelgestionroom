...
export function LeftSidebar({ username, companyName }: LeftSidebarProps) {
  ...
  return (
    <aside
      className={cn(
        "flex flex-col bg-sidebar border-r border-sidebar-border text-sidebar-foreground transition-all duration-300 shrink-0",
    ...
    >
      ...
      {/* Unlock card */}
      {!collapsed && (
        <div className="mx-3 mb-3 rounded-xl bg-gradient-to-br from-primary/5 via-primary/10 to-primary/5 border border-primary/10 p-4 space-y-3">
